(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('stream'), require('http'), require('url'), require('punycode'), require('https'), require('zlib'), require('pako'), require('wildcard-match'), require('flat')) :
  typeof define === 'function' && define.amd ? define(['exports', 'stream', 'http', 'url', 'punycode', 'https', 'zlib', 'pako', 'wildcard-match', 'flat'], factory) :
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.FlatFileListener = {}, global.Stream, global.http, global.Url, global.require$$0$1, global.https, global.zlib, global.pako, global.wildMatch, global.flat));
})(this, (function (exports, Stream, http, Url, require$$0$1, https, zlib, pako, wildMatch, flat) { 'use strict';
  ...
  var require$$0 = /*@__PURE__*/getDefaultExportFromNamespaceIfNotNamed(lib);
