 ...
 */
export declare type EventTopic = "agent:created" | "agent:updated" | "agent:deleted" | "space:created" | "space:updated" | "space:deleted" | "space:expired" | "document:created" | "document:updated" | "document:deleted" | "workbook:created" | "workbook:updated" | "workbook:deleted" | "workbook:expired" | "sheet:created" | "sheet:updated" | "sheet:deleted" | "snapshot:created" | "records:created" | "records:updated" | "records:deleted" | "file:created" | "file:updated" | "file:deleted" | "file:expired" | "job:created" | "job:updated" | "job:deleted" | "job:completed" | "job:ready" | "job:scheduled" | "job:outcome-acknowledged" | "job:parts-completed" | "job:failed" | "program:created" | "program:updated" | "commit:created" | "commit:updated" | "commit:completed" | "layer:created";
